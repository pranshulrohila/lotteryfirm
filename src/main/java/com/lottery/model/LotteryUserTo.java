...
public class LotteryUserTo implements Serializable {
	...
	@Size(min = 5, max = 18, message = "The Mobile Number '${validatedValue}' must be between {min} and {max} characters long")
	...
	public String toString() {
		...
		builder.append("LotteryUserTo [userId=").append(userId).append(", userVersion=").append(userVersion)
				...
				.append(", mobileNo=").append(mobileNo).append(", dateOfBirth=").append(dateOfBirth).append("]");
