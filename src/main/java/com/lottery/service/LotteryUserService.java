...
import com.lottery.entity.LotteryUserLoginTo;
...
public class LotteryUserService {
	...
	public String login(LotteryUserLoginTo userTo) {
		LotteryUser userJpa = lotteryUserRepository.findByMobileNo(userTo.getMobileNo());
	...
	public String signUp(LotteryUserTo createUserTo) {
		...
		LotteryUser existingUser = lotteryUserRepository.findByMobileNo(createUserTo.getMobileNo());
